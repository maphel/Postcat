...
| `scripts/pack.js`, `scripts/screenshot.js` | Zip for distribution (excludes `src/build-info.js`; `test/pack.test.js` checks that); renders `docs/screenshot.png` (the README image) through the harness |
